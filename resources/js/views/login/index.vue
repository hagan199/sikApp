    ...
    <div class="login-container">
      <div class="login-image">
        <div class="photo-credit">
          <span>Powered by SikaAPP</span>
        </div>
      </div>
      <div class="login-content">
        <el-form ref="ruleFormRef" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on"
                 label-position="left">
          ...
          <el-form-item prop="email">
            ...
            <el-input v-model="loginForm.email" name="email" type="text" autocomplete="on"
          ...
          <div class="tips">
            <span class="email-tip">Email: admin@laravel-vue-admin.trumanwl.com</span>
            <span class="password-tip">Password: 123456</span>
          </div>
        </el-form>
      </div>
    </div>
